...
tools: Read, Write, Bash, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__cipher__cipher_extract_and_operate_memory, mcp__cipher__cipher_memory_search, mcp__cipher__cipher_store_reasoning_memory, mcp__cipher__cipher_search_reasoning_patterns, mcp__git-mcp__search_generic_code
---
